...
//TJ, I added here a hist for TOT
  static HistogramAxis module_tot[]={axis_full_tot,axis_full_energy};
  static HistogramAxis module_tot_all[]={axis_full_tot,axis_full_energy};
  ...
  if (!globals_initialized)
    {
      ...
      //TJ added this line:
      new HistFillerSubprocessor<TH(2,I), 1>(&any, module_tot_all);
  ...
  if (!this->energy_subprocessors.count(idx))
	...
	//						 &idx, &axis_full_energy);
      ...
      //TJ changed added the follwing line:
      new HistFillerSubprocessor<TH(2,I), 1>(&idx, module_tot);
      ...
      //new HistFillerSubprocessor<TH(2,I), 1>(&idx, qpid_axis,128);
